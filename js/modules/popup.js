...
const createPopup = (evt) => {
  ...
  const targetComment = parent.querySelector('.picture__comments');
  const targetLike = parent.querySelector('.picture__likes');
  body.classList.add('modal-open');
  bigPicture.classList.toggle('hidden');
  image.src = target.src;
  likes.textContent = targetLike.textContent;
  numberComments.textContent = targetComment.textContent;
